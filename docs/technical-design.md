...
- Shelter navigation is object-driven rather than sign-driven. Generated physical props are layered over the empty classroom background, their texture bounds define mouse interaction, and hover draws a red silhouette outline. The Mission Map is pinned to the left side of the blackboard and opens mission selection. Character Area is omitted from drawing and hit testing until a companion is introduced.
